...
static const unsigned int barmargx   = 220;

static const int showbar            = 1;
static const int topbar             = 1;
static const int barheight          = 8;
static const int splitstatus        = 1;
static const int tagmarkers         = 0;
static const char *splitdelim       = ";";

static const char *fonts[]          = { "CodeNewRomanNerdFont-Regular:size=10" };
